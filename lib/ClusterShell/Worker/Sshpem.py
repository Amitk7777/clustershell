...
class SshPemClient(ExecClient):
    ...
    def _build_cmd(self):
        ...
        """
        print("sshpem.py: SshPemClient: _build_cmd")
        ...
        print("sshpem.py: cmd_l:", cmd_l)

        return (cmd_l, None)

class ScpPemClient(CopyClient):
    """
    Scp EngineClient.
    """
    ...
    def _build_cmd(self):
        ...
        Return an array of command and arguments.
        """
        print("sshpem.py: scpPemclient: _build_cmd")
        ...
        print("sshpem.py: scpPemclient: cmd_l:", cmd_l)
        return (cmd_l, None)

class WorkerSshPem(ExecWorker):
    """
    ...
    Remote Copy (scp) usage example:
       ...
       >>> task.resume()              # run
    """
    print("sshpem.py: WorkerSshPem: __init__")
    SHELL_CLASS = SshPemClient
    COPY_CLASS = ScpPemClient

WORKER_CLASS=WorkerSshPem
