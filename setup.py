...
# Copyright (C) 2016-2023 Stephane Thiell <sthiell@stanford.edu>
#
      ...
      data_files=[(CFGDIR,
                  ...
                  (os.path.join(CFGDIR, 'clush.conf.d'),
                   ['conf/clush.conf.d/sshpass.conf',
                    'conf/clush.conf.d/sshpem.conf',
                    'conf/clush.conf.d/kubectl.conf',
                  ...
                  (os.path.join(CFGDIR, 'groups.conf.d'),
                   ['conf/groups.conf.d/genders.conf.example',
                    ...
                    'conf/groups.conf.d/pods.conf',
                    'conf/groups.conf.d/nodes.conf',
